...
namespace IntegrationAutomation.CurrentRelease.Tests.PageObjectPages.GenericObjects
{
    public class GenericPage:PageObjectBase
    {
        ...
        {
            GenericWindowButton.ByLocator = By.CssSelector($"[dataqaid= '{buttonName}']," +
                                                           $"[type='{buttonName}']," +
                                                           $"[name ='{buttonName}']," +
                                                           $"[value = '{buttonName}']," +
                                                           $"[id = '{buttonName}']," +
         ...
         public Button GetButtonByLinkText(string elementName)
       {
        ...
        {
            GenericWindowLabel.ByLocator = By.XPath($"//div[contains(text(),'{elementName}')] | //h3[contains(text(),'{elementName}')] | //h2[contains(text(),'{elementName}')] | //b[contains(text(),'{elementName}')] | //p[contains(text(),'{elementName}')] | //a[contains(text(),'{elementName}')] | //td[contains(text(),'{elementName}')] | //button[contains(text(), '{elementName}')]");
            return GenericWindowLabel;
        }
        public Label GetMultiElementsByText(string elementName, int elementNumber)
        {
            GenericWindowLabel.ByLocator = By.XPath($"(//td[contains(text(),'{elementName}')])[{elementNumber}]");
            return GenericWindowLabel;
        }
        ...
        public CheckBox GetCreditType(string creditName)
        {
            GenericCheckBox.ByLocator = By.XPath($"//tr[.//*[contains(text(), '{creditName}')]]//*[@class='slds-checkbox--faux']");
            return GenericCheckBox;
        }
        
        public CheckBox GetMultipleCreditTypes(string creditName, int elementNumber)
        {
            GenericCheckBox.ByLocator = By.XPath($"(//tr[.//*[contains(text(), '{creditName}')]]//*[@class='slds-checkbox--faux'])[{elementNumber}]");
            return GenericCheckBox;
        }
        ...
        /// <returns></returns>
        public Table GetTableRowDataByXPath(string creditType, string element)
        {
            GenericTable.ByLocator = By.XPath($"//tr[.//*[contains(text(), '{creditType}')]]//*[contains(text(),'{element}')]");
            return GenericTable;
        }
        
        public Table GetMultTableRowDataByXPath(string creditType, string element, int elementNumber)
        {
            GenericTable.ByLocator = By.XPath($"(//tr[.//*[contains(text(), '{creditType}')]]//*[contains(text(),'{element}')])[{elementNumber}]");
            return GenericTable;
        }
